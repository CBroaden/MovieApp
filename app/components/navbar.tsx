...
export default async function Navbar() {
    ...
    return(
        <nav  id="sidebar" className="h-full z-30 md:w-[20%] hidden w-full bg-2 text-center md:text-left z-500 px-4 text-xl font-bold md:flex flex-col fixed p-2 border-r border-black">
  
          <div className="h-1/4 flex flex-col justify-between p-2 mt-2 ml-1">
