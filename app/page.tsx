...
export default async function Home() {
  ...
  return (
    <main className="pt-6 flex flex-col min-h-screen items-center ">
      <h1 className='text-2xl ml-0 w-full text-left font-bold mb-4'>Home</h1>
      <PostForm/>
      <div className='[&>*]:mx-auto [&>*]:w-2/3 w-full bg-neutral-100 py-2 mb-2 px-4 shadow shadow-black rounded-xl'>
        <h1 className='text-xl font-bold text-center mb-4'>Find Movie</h1>
        <SearchBar/>
      </div>
      <div className='mx-auto w-full bg-neutral-100 py-2 mb-2 px-4 shadow shadow-black rounded-xl'>
